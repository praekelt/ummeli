...
urlpatterns = patterns('',
    ...
    url(r'^jobs/$', 'ummeli.vlive.views.jobs_province', name='jobs_province'),
    url(r'^jobs/(?P<id>-\d+|\d+)/$',
        'ummeli.vlive.views.jobs_list',
        name='jobs_list'),
    url(r'^jobs/(?P<search_id>-\d+|\d+)/(?P<id>\d+)/$',
        'ummeli.vlive.views.jobs',
        name='jobs'),
    url(r'^jobs/(?P<search_id>-\d+|\d+)/(?P<cat_id>\d+)/(?P<id>\d+)/$',
        'ummeli.vlive.views.job',
        name='job'),
    url(r'^jobs/(?P<search_id>-\d+|\d+)/(?P<cat_id>\d+)/(?P<id>\d+)/(?P<user_submitted>\d+)/$',
        'ummeli.vlive.views.job',
        name='job'),
