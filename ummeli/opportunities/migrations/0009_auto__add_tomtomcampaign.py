...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TomTomCampaign'
        db.create_table('opportunities_tomtomcampaign', (
            ('campaign_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['opportunities.Campaign'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('opportunities', ['TomTomCampaign'])


    def backwards(self, orm):
        
        # Deleting model 'TomTomCampaign'
        db.delete_table('opportunities_tomtomcampaign')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 19, 16, 46, 9, 612389)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 19, 16, 46, 9, 612118)'}),
