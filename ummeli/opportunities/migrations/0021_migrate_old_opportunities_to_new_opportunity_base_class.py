...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        UmmeliJob = orm['opportunities.UmmeliJob']
        UmmeliBursary = orm['opportunities.UmmeliBursary']
        UmmeliInternship = orm['opportunities.UmmeliInternship']
        UmmeliTraining = orm['opportunities.UmmeliTraining']
        UmmeliVolunteer = orm['opportunities.UmmeliVolunteer']

        Job = orm['opportunities.Job']
        Bursary = orm['opportunities.Bursary']
        Internship = orm['opportunities.Internship']
        Training = orm['opportunities.Training']
        Volunteer = orm['opportunities.Volunteer']

        for job in Job.objects.all():
            j = UmmeliJob.objects.create(title=job.title,
                                         ...
                                         salary=job.salary,
                                         place=job.place,
                                         is_community=job.is_community,
                                         owner=job.owner,
                                         state=job.state,
                                         created=job.created)
            j.sites.add(job.sites)
            j.save()

        for item in Bursary.objects.all():
            i = UmmeliBursary.objects.create(title=item.title,
            ...
            i.sites.add(item.sites)
            i.save()

        for item in Internship.objects.all():
            i = UmmeliInternship.objects.create(title=item.title,
                                             description=item.description,
                                             category=item.category,
                                             province=item.province,
                                             education=item.education,
        ...
        for item in Training.objects.all():
            i = UmmeliTraining.objects.create(title=item.title,
                                             description=item.description,
                                             category=item.category,
                                             province=item.province,
                                             education=item.education,
        ...
        for item in Volunteer.objects.all():
            i = UmmeliVolunteer.objects.create(title=item.title,
                                             description=item.description,
                                             category=item.category,
                                             province=item.province,
                                             education=item.education,
    ...
    def backwards(self, orm):
        # Only migrating existing data
        # No backwards migrations needed
        pass
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 6, 16, 45, 26, 499171)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 6, 16, 45, 26, 499057)'}),
