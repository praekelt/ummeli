...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TaskCheckout'
        db.create_table('opportunities_taskcheckout', (
        ...
        db.send_create_signal('opportunities', ['TaskCheckout'])

        # Adding field 'MicroTask.users_per_task'
        db.add_column('opportunities_microtask', 'users_per_task', self.gf('django.db.models.fields.PositiveIntegerField')(default=1), keep_default=False)

        # Adding field 'MicroTask.hours_per_task'
        db.add_column('opportunities_microtask', 'hours_per_task', self.gf('django.db.models.fields.PositiveIntegerField')(default=24), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'TaskCheckout'
        db.delete_table('opportunities_taskcheckout')

        # Deleting field 'MicroTask.users_per_task'
        db.delete_column('opportunities_microtask', 'users_per_task')

        # Deleting field 'MicroTask.hours_per_task'
        db.delete_column('opportunities_microtask', 'hours_per_task')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 24, 9, 36, 26, 757056)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 24, 9, 36, 26, 756970)'}),
