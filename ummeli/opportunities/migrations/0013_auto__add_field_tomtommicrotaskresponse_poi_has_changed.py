...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TomTomMicroTaskResponse.poi_has_changed'
        db.add_column('opportunities_tomtommicrotaskresponse', 'poi_has_changed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TomTomMicroTaskResponse.poi_has_changed'
        db.delete_column('opportunities_tomtommicrotaskresponse', 'poi_has_changed')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 22, 12, 52, 30, 661677)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 22, 12, 52, 30, 661400)'}),
