...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MicroTaskResponse.date_updated'
        db.add_column('opportunities_microtaskresponse', 'date_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 2, 22, 18, 13, 57, 360990), blank=True), keep_default=False)

        # Adding field 'MicroTaskResponse.reject_reason'
        db.add_column('opportunities_microtaskresponse', 'reject_reason', self.gf('django.db.models.fields.PositiveIntegerField')(default=1), keep_default=False)

        # Adding field 'MicroTaskResponse.reject_comment'
        db.add_column('opportunities_microtaskresponse', 'reject_comment', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MicroTaskResponse.date_updated'
        db.delete_column('opportunities_microtaskresponse', 'date_updated')

        # Deleting field 'MicroTaskResponse.reject_reason'
        db.delete_column('opportunities_microtaskresponse', 'reject_reason')

        # Deleting field 'MicroTaskResponse.reject_comment'
        db.delete_column('opportunities_microtaskresponse', 'reject_comment')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 22, 18, 14, 27, 676155)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 22, 18, 14, 27, 676049)'}),
        ...
        'opportunities.microtaskresponse': {
            ...
            'reject_reason': ('django.db.models.fields.PositiveIntegerField', [], {}),
