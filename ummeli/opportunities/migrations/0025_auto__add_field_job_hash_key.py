...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Job.hash_key'
        db.add_column('opportunities_job', 'hash_key', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=32, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Job.hash_key'
        db.delete_column('opportunities_job', 'hash_key')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 20, 18, 53, 55, 712596)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 20, 18, 53, 55, 712505)'}),
