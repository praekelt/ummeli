...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MicroTaskResponse'
        db.create_table('opportunities_microtaskresponse', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('task', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opportunities.MicroTask'])),
            ('task_checkout', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['opportunities.TaskCheckout'], unique=True)),
            ('state', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('opportunities', ['MicroTaskResponse'])

        # Adding model 'TomTomMicroTaskResponse'
        db.create_table('opportunities_tomtommicrotaskresponse', (
            ('microtaskresponse_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['opportunities.MicroTaskResponse'], unique=True, primary_key=True)),
            ('file', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('tel_1', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('tel_2', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ...
        db.send_create_signal('opportunities', ['TomTomMicroTaskResponse'])


    def backwards(self, orm):
        
        # Deleting model 'MicroTaskResponse'
        db.delete_table('opportunities_microtaskresponse')

        # Deleting model 'TomTomMicroTaskResponse'
        db.delete_table('opportunities_tomtommicrotaskresponse')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 6, 13, 58, 38, 390414)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 6, 13, 58, 38, 390327)'}),
