...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('opportunities_microtask', (
        ...
        db.send_create_signal('opportunities', ['MicroTask'])

        # Adding M2M table for field province on 'MicroTask'
        db.create_table('opportunities_microtask_province', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('microtask', models.ForeignKey(orm['opportunities.microtask'], null=False)),
            ('province', models.ForeignKey(orm['opportunities.province'], null=False))
        ))
        db.create_unique('opportunities_microtask_province', ['microtask_id', 'province_id'])

        # Adding model 'Campaign'
        db.create_table('opportunities_campaign', (
            ('modelbase_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['jmbo.ModelBase'], unique=True, primary_key=True)),
            ('education', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('salary', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['opportunities.Salary'], null=True, blank=True)),
            ('location', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True)),
        ))
        db.send_create_signal('opportunities', ['Campaign'])

        # Adding M2M table for field province on 'Campaign'
        db.create_table('opportunities_campaign_province', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('campaign', models.ForeignKey(orm['opportunities.campaign'], null=False)),
            ('province', models.ForeignKey(orm['opportunities.province'], null=False))
        ))
        db.create_unique('opportunities_campaign_province', ['campaign_id', 'province_id'])

        # Adding M2M table for field tasks on 'Campaign'
        db.create_table('opportunities_campaign_tasks', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('campaign', models.ForeignKey(orm['opportunities.campaign'], null=False)),
            ('microtask', models.ForeignKey(orm['opportunities.microtask'], null=False))
        ))
        db.create_unique('opportunities_campaign_tasks', ['campaign_id', 'microtask_id'])


    def backwards(self, orm):
        # Deleting model 'MicroTask'
        db.delete_table('opportunities_microtask')

        # Removing M2M table for field province on 'MicroTask'
        db.delete_table('opportunities_microtask_province')

        # Deleting model 'Campaign'
        db.delete_table('opportunities_campaign')

        # Removing M2M table for field province on 'Campaign'
        db.delete_table('opportunities_campaign_province')

        # Removing M2M table for field tasks on 'Campaign'
        db.delete_table('opportunities_campaign_tasks')
