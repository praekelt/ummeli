...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MicroTaskResponse.reject_reason'
        db.alter_column('opportunities_microtaskresponse', 'reject_reason', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'MicroTaskResponse.reject_reason'
        db.alter_column('opportunities_microtaskresponse', 'reject_reason', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 22, 18, 24, 43, 619090)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 22, 18, 24, 43, 619001)'}),
