...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_table('opportunities_ummelibursary', 'opportunities_bursary')
        db.send_create_signal('opportunities', ['Bursary'])

        # Deleting model 'UmmeliJob'
        db.rename_table('opportunities_ummelijob', 'opportunities_job')
        db.send_create_signal('opportunities', ['Job'])

        # Deleting model 'UmmeliVolunteer'
        db.rename_table('opportunities_ummelivolunteer', 'opportunities_volunteer')
        db.send_create_signal('opportunities', ['Volunteer'])

        # Deleting model 'UmmeliTraining'
        db.rename_table('opportunities_ummelitraining', 'opportunities_training')
        db.send_create_signal('opportunities', ['Training'])

        # Deleting model 'UmmeliInternship'
        db.rename_table('opportunities_ummeliinternship', 'opportunities_internship')
    ...
    def backwards(self, orm):
       ...
       # Deleting model 'UmmeliBursary'
        db.rename_table('opportunities_bursary', 'opportunities_ummelibursary')
        db.send_create_signal('opportunities', ['UmmeliBursary'])

        # Deleting model 'UmmeliJob'
        db.rename_table('opportunities_job', 'opportunities_ummelijob')
        db.send_create_signal('opportunities', ['UmmeliJob'])

        # Deleting model 'UmmeliVolunteer'
        db.rename_table('opportunities_volunteer', 'opportunities_ummelivolunteer')
        db.send_create_signal('opportunities', ['UmmeliVolunteer'])

        # Deleting model 'UmmeliTraining'
        db.rename_table('opportunities_training', 'opportunities_ummelitraining')
        db.send_create_signal('opportunities', ['UmmeliTraining'])

        # Deleting model 'UmmeliInternship'
        db.rename_table('opportunities_internship', 'opportunities_ummeliinternship')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 6, 17, 9, 48, 85338)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 6, 17, 9, 48, 85249)'}),
