...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UmmeliBursary'
        db.create_table('opportunities_ummelibursary', (
        ...
        db.send_create_signal('opportunities', ['UmmeliBursary'])

        # Adding model 'UmmeliInternship'
        db.create_table('opportunities_ummeliinternship', (
            ('ummeliopportunity_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['opportunities.UmmeliOpportunity'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('opportunities', ['UmmeliInternship'])

        # Adding model 'UmmeliVolunteer'
        db.create_table('opportunities_ummelivolunteer', (
            ('ummeliopportunity_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['opportunities.UmmeliOpportunity'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('opportunities', ['UmmeliVolunteer'])

        # Adding model 'UmmeliTraining'
        db.create_table('opportunities_ummelitraining', (
            ('ummeliopportunity_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['opportunities.UmmeliOpportunity'], unique=True, primary_key=True)),
            ('cost', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2)),
        ))
        db.send_create_signal('opportunities', ['UmmeliTraining'])

        # Adding model 'UmmeliJob'
        db.create_table('opportunities_ummelijob', (
            ('ummeliopportunity_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['opportunities.UmmeliOpportunity'], unique=True, primary_key=True)),
            ('category', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
        db.send_create_signal('opportunities', ['UmmeliJob'])


    def backwards(self, orm):
        
        # Deleting model 'UmmeliBursary'
        db.delete_table('opportunities_ummelibursary')

        # Deleting model 'UmmeliInternship'
        db.delete_table('opportunities_ummeliinternship')

        # Deleting model 'UmmeliVolunteer'
        db.delete_table('opportunities_ummelivolunteer')

        # Deleting model 'UmmeliTraining'
        db.delete_table('opportunities_ummelitraining')

        # Deleting model 'UmmeliJob'
        db.delete_table('opportunities_ummelijob')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 6, 16, 43, 37, 419258)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 6, 16, 43, 37, 419165)'}),
        ...
        'opportunities.ummelibursary': {
            'Meta': {'ordering': "('-created',)", 'object_name': 'UmmeliBursary', '_ormbases': ['opportunities.UmmeliOpportunity']},
        ...
        'opportunities.ummeliinternship': {
            'Meta': {'ordering': "('-created',)", 'object_name': 'UmmeliInternship', '_ormbases': ['opportunities.UmmeliOpportunity']},
            'ummeliopportunity_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['opportunities.UmmeliOpportunity']", 'unique': 'True', 'primary_key': 'True'})
        },
        'opportunities.ummelijob': {
            'Meta': {'ordering': "('-created',)", 'object_name': 'UmmeliJob', '_ormbases': ['opportunities.UmmeliOpportunity']},
            'category': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'ummeliopportunity_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['opportunities.UmmeliOpportunity']", 'unique': 'True', 'primary_key': 'True'})
        },
        ...
        'opportunities.ummelitraining': {
            'Meta': {'ordering': "('-created',)", 'object_name': 'UmmeliTraining', '_ormbases': ['opportunities.UmmeliOpportunity']},
            'cost': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '12', 'decimal_places': '2'}),
            'ummeliopportunity_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['opportunities.UmmeliOpportunity']", 'unique': 'True', 'primary_key': 'True'})
        },
        'opportunities.ummelivolunteer': {
            'Meta': {'ordering': "('-created',)", 'object_name': 'UmmeliVolunteer', '_ormbases': ['opportunities.UmmeliOpportunity']},
            'ummeliopportunity_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['opportunities.UmmeliOpportunity']", 'unique': 'True', 'primary_key': 'True'})
        },
