...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field qualifiers on 'Campaign'
        db.create_table('opportunities_campaign_qualifiers', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('campaign', models.ForeignKey(orm['opportunities.campaign'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('opportunities_campaign_qualifiers', ['campaign_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field qualifiers on 'Campaign'
        db.delete_table('opportunities_campaign_qualifiers')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 20, 13, 9, 11, 182215)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 20, 13, 9, 11, 181765)'}),
