...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TomTomMicroTask'
        db.create_table('opportunities_tomtommicrotask', (
            ('microtask_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['opportunities.MicroTask'], unique=True, primary_key=True)),
            ('category', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('poi_id', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('city', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('suburb', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ...
        db.send_create_signal('opportunities', ['TomTomMicroTask'])


    def backwards(self, orm):
        
        # Deleting model 'TomTomMicroTask'
        db.delete_table('opportunities_tomtommicrotask')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 13, 12, 24, 53, 392588)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 13, 12, 24, 53, 392321)'}),
