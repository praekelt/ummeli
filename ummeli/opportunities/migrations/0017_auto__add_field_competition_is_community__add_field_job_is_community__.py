...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Competition.is_community'
        db.add_column('opportunities_competition', 'is_community', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Job.is_community'
        db.add_column('opportunities_job', 'is_community', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Event.is_community'
        db.add_column('opportunities_event', 'is_community', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'MicroTask.is_community'
        db.add_column('opportunities_microtask', 'is_community', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Training.is_community'
        db.add_column('opportunities_training', 'is_community', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Internship.is_community'
        db.add_column('opportunities_internship', 'is_community', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Bursary.is_community'
        db.add_column('opportunities_bursary', 'is_community', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Campaign.is_community'
        db.add_column('opportunities_campaign', 'is_community', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Volunteer.is_community'
        db.add_column('opportunities_volunteer', 'is_community', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Competition.is_community'
        db.delete_column('opportunities_competition', 'is_community')

        # Deleting field 'Job.is_community'
        db.delete_column('opportunities_job', 'is_community')

        # Deleting field 'Event.is_community'
        db.delete_column('opportunities_event', 'is_community')

        # Deleting field 'MicroTask.is_community'
        db.delete_column('opportunities_microtask', 'is_community')

        # Deleting field 'Training.is_community'
        db.delete_column('opportunities_training', 'is_community')

        # Deleting field 'Internship.is_community'
        db.delete_column('opportunities_internship', 'is_community')

        # Deleting field 'Bursary.is_community'
        db.delete_column('opportunities_bursary', 'is_community')

        # Deleting field 'Campaign.is_community'
        db.delete_column('opportunities_campaign', 'is_community')

        # Deleting field 'Volunteer.is_community'
        db.delete_column('opportunities_volunteer', 'is_community')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 30, 15, 46, 26, 55433)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 30, 15, 46, 26, 55337)'}),
