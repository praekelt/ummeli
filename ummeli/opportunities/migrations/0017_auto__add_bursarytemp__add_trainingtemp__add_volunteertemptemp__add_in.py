...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'BursaryTemp'
        db.create_table('opportunities_bursarytemp', (
        ...
        db.send_create_signal('opportunities', ['BursaryTemp'])

        # Adding model 'TrainingTemp'
        db.create_table('opportunities_trainingtemp', (
            ('ummeliopportunity_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['opportunities.UmmeliOpportunity'], unique=True, primary_key=True)),
            ('cost', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2)),
        ))
        db.send_create_signal('opportunities', ['TrainingTemp'])

        # Adding model 'VolunteerTempTemp'
        db.create_table('opportunities_volunteertemptemp', (
            ('ummeliopportunity_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['opportunities.UmmeliOpportunity'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('opportunities', ['VolunteerTempTemp'])

        # Adding model 'InternshipTemp'
        db.create_table('opportunities_internshiptemp', (
            ('ummeliopportunity_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['opportunities.UmmeliOpportunity'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('opportunities', ['InternshipTemp'])

        # Adding model 'JobTemp'
        db.create_table('opportunities_jobtemp', (
            ('ummeliopportunity_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['opportunities.UmmeliOpportunity'], unique=True, primary_key=True)),
            ('category', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('hash_key', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=32, null=True, blank=True)),
        ))
        db.send_create_signal('opportunities', ['JobTemp'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'BursaryTemp'
        db.delete_table('opportunities_bursarytemp')

        # Deleting model 'TrainingTemp'
        db.delete_table('opportunities_trainingtemp')

        # Deleting model 'VolunteerTempTemp'
        db.delete_table('opportunities_volunteertemptemp')

        # Deleting model 'InternshipTemp'
        db.delete_table('opportunities_internshiptemp')

        # Deleting model 'JobTemp'
        db.delete_table('opportunities_jobtemp')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 4, 23, 55, 22, 910949)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 4, 23, 55, 22, 910860)'}),
