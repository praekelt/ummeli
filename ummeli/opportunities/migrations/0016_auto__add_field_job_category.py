...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('opportunities_job', 'category', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Job.category'
        db.delete_column('opportunities_job', 'category')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 19, 12, 36, 31, 377873)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 19, 12, 36, 31, 377594)'}),
