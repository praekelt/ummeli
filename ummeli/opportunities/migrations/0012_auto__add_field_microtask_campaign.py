...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MicroTask.campaign'
        db.add_column('opportunities_microtask', 'campaign', self.gf('django.db.models.fields.related.ForeignKey')(default=128, to=orm['opportunities.Campaign']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'MicroTask.campaign'
        db.delete_column('opportunities_microtask', 'campaign_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 22, 11, 49, 39, 462181)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 22, 11, 49, 39, 461909)'}),
        ...
        'opportunities.microtask': {
            ...
            'campaign': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['opportunities.Campaign']"}),
            'education': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
