...
class Migration(DataMigration):
    def convert_community_job_to_opportunity(self, community_job, model=None):
        ...
        from ummeli.opportunities.models import JobTemp as Job
        return Job(title=community_job.title,
    ...
    def backwards(self, orm):
        ...
        Job.objects.filter(is_community=True).delete()
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 4, 23, 56, 52, 576058)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 4, 23, 56, 52, 575976)'}),
