...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CurriculumVitae.province'
        db.add_column('base_curriculumvitae', 'province', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CurriculumVitae.province'
        db.delete_column('base_curriculumvitae', 'province')
    ...
    models = {
        ...
        'base.article': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 12, 16, 59, 44, 884384)', 'blank': 'True'}),
