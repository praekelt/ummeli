...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CurriculumVitae.street_name'
        db.delete_column('base_curriculumvitae', 'street_name')

        # Deleting field 'CurriculumVitae.house_number'
        db.delete_column('base_curriculumvitae', 'house_number')

        # Deleting field 'CurriculumVitae.location'
        db.delete_column('base_curriculumvitae', 'location')

        # Adding field 'CurriculumVitae.address'
        db.add_column('base_curriculumvitae', 'address', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'CurriculumVitae.city'
        db.add_column('base_curriculumvitae', 'city', self.gf('django.db.models.fields.CharField')(max_length=45, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'CurriculumVitae.street_name'
        db.add_column('base_curriculumvitae', 'street_name', self.gf('django.db.models.fields.CharField')(max_length=45, null=True, blank=True), keep_default=False)

        # Adding field 'CurriculumVitae.house_number'
        db.add_column('base_curriculumvitae', 'house_number', self.gf('django.db.models.fields.CharField')(max_length=45, null=True, blank=True), keep_default=False)

        # Adding field 'CurriculumVitae.location'
        db.add_column('base_curriculumvitae', 'location', self.gf('django.db.models.fields.CharField')(max_length=45, null=True, blank=True), keep_default=False)

        # Deleting field 'CurriculumVitae.address'
        db.delete_column('base_curriculumvitae', 'address')

        # Deleting field 'CurriculumVitae.city'
        db.delete_column('base_curriculumvitae', 'city')
    ...
    models = {
        ...
        'base.article': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 10, 14, 45, 26, 522326)', 'blank': 'True'}),
