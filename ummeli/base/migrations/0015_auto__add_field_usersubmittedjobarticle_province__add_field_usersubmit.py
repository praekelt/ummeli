...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserSubmittedJobArticle.province'
        db.add_column('base_usersubmittedjobarticle', 'province', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        # Adding field 'UserSubmittedJobArticle.job_category'
        db.add_column('base_usersubmittedjobarticle', 'job_category', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserSubmittedJobArticle.province'
        db.delete_column('base_usersubmittedjobarticle', 'province')

        # Deleting field 'UserSubmittedJobArticle.job_category'
        db.delete_column('base_usersubmittedjobarticle', 'job_category')
    ...
    models = {
        ...
        'base.article': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 11, 13, 50, 44, 528583)', 'blank': 'True'}),
