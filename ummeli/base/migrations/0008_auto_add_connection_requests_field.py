...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field connection_requests on 'CurriculumVitae'
        db.create_table('base_curriculumvitae_connection_requests', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('curriculumvitae', models.ForeignKey(orm['base.curriculumvitae'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('base_curriculumvitae_connection_requests', ['curriculumvitae_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field connection_requests on 'CurriculumVitae'
        db.delete_table('base_curriculumvitae_connection_requests')
    ...
    models = {
        ...
        'base.article': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 6, 8, 40, 32, 514309)', 'blank': 'True'}),
