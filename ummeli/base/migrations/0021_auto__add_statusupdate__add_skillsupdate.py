...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('base_statusupdate', (
            ('modelbase_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['jmbo.ModelBase'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('base', ['StatusUpdate'])

        # Adding model 'SkillsUpdate'
        db.create_table('base_skillsupdate', (
            ('modelbase_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['jmbo.ModelBase'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('base', ['SkillsUpdate'])


    def backwards(self, orm):
        
        # Deleting model 'StatusUpdate'
        db.delete_table('base_statusupdate')

        # Deleting model 'SkillsUpdate'
        db.delete_table('base_skillsupdate')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 29, 13, 25, 33, 746190)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 29, 13, 25, 33, 746104)'}),
        ...
        'base.article': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 29, 13, 25, 33, 492460)', 'blank': 'True'}),
        ...
        'base.skillsupdate': {
            'Meta': {'ordering': "('-created',)", 'object_name': 'SkillsUpdate', '_ormbases': ['jmbo.ModelBase']},
            'modelbase_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['jmbo.ModelBase']", 'unique': 'True', 'primary_key': 'True'})
        },
        'base.statusupdate': {
            'Meta': {'ordering': "('-created',)", 'object_name': 'StatusUpdate', '_ormbases': ['jmbo.ModelBase']},
            'modelbase_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['jmbo.ModelBase']", 'unique': 'True', 'primary_key': 'True'})
        },
