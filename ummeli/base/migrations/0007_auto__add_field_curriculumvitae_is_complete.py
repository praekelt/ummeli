...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CurriculumVitae.is_complete'
        db.add_column('base_curriculumvitae', 'is_complete', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CurriculumVitae.is_complete'
        db.delete_column('base_curriculumvitae', 'is_complete')
    ...
    models = {
        ...
        'base.article': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 10, 8, 0, 5, 919830)', 'blank': 'True'}),
