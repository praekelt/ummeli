...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CurriculumVitae.about_me'
        db.add_column('base_curriculumvitae', 'about_me', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CurriculumVitae.about_me'
        db.delete_column('base_curriculumvitae', 'about_me')
    ...
    models = {
        ...
        'base.article': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 10, 15, 24, 2, 356141)', 'blank': 'True'}),
