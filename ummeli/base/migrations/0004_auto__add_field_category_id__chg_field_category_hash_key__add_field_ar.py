...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('base_category', 'id')

        # Changing field 'Category.hash_key'
        db.alter_column('base_category', 'hash_key', self.gf('django.db.models.fields.CharField')(max_length=32, primary_key=True))

        # Deleting field 'Article.id'
        db.delete_column('base_article', 'id')

        # Changing field 'Article.hash_key'
        db.alter_column('base_article', 'hash_key', self.gf('django.db.models.fields.CharField')(max_length=32, primary_key=True))
    ...
    models = {
        ...
        'base.article': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 27, 7, 1, 29, 617832)', 'blank': 'True'}),
