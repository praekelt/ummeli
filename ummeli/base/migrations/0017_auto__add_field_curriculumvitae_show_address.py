...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CurriculumVitae.show_address'
        db.add_column('base_curriculumvitae', 'show_address', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CurriculumVitae.show_address'
        db.delete_column('base_curriculumvitae', 'show_address')
    ...
    models = {
        ...
        'base.article': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 12, 12, 35, 55, 411322)', 'blank': 'True'}),
