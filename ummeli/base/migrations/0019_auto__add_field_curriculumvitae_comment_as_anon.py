...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CurriculumVitae.comment_as_anon'
        db.add_column('base_curriculumvitae', 'comment_as_anon', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CurriculumVitae.comment_as_anon'
        db.delete_column('base_curriculumvitae', 'comment_as_anon')
    ...
    models = {
        ...
        'base.article': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 13, 12, 18, 52, 85763)', 'blank': 'True'}),
